...
namespace Console_Twitter
{
    ...
    class TwitterLibrary
    {
        ...
        private string _consumerkey = "WvIT7wje8o104o7UU1j82bZWE";
        private string _consumersecret = "N0ewKX23Kx8ko4fCAxFrVsU5BPAM8eOWTvDx9AFYkNLtagx3vT";

        private string _accesstoken = "2647289394-f2nwtHlj6gO3bGVprjlQOGDAjgCxE3ulxZqICtI";
        private string _accesstokensecret = "jjl6Bt85vS63x5R6NhscLFU6JFrweEPzpScdX5VOCnjbo";

        private string _requesttoken_url = "https://api.twitter.com/oauth/request_token";
        private string _authorize_url = "https://api.twitter.com/oauth/authorize";
